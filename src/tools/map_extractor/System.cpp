...
struct map_fileheader // 
{
    ...
    uint32 versionMagic;
    uint32 buildMagic;
    uint32 areaMapOffset; // 地图区域偏移
    uint32 areaMapSize; // 地图区域大小
    uint32 heightMapOffset; // 地图高度偏移
    uint32 heightMapSize; // 地图高度大小
    uint32 liquidMapOffset; // 地图流体偏移
    uint32 liquidMapSize; // 地图流体大小
    uint32 holesOffset; // 地图洞偏移
    uint32 holesSize; // 地图洞大小
};
