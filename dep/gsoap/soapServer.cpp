/* soapServer.cpp
   由 gSOAP 2.8.117 为 gsoap.stub 生成

gSOAP XML Web 服务工具
版权所有 （C） 2000-2021，Robert van Engelen，Genivia Inc.保留所有权利。
soapcpp2 工具及其生成的软件按照 GPL 发布。
该程序根据 GPL 发布，但有额外的豁免
允许编译、链接和/或使用 OpenSSL。
--------------------------------------------------------------------------------
商业使用许可证可从 Genivia Inc. 获得，contact@genivia.com
--------------------------------------------------------------------------------
*/
